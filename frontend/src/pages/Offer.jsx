...
const Offer = () => {
  ...
  const howItWorks = [
    ...
    {
      step: '2',
      title: 'استلم رابط التطبيق',
      description: 'ستستلم رابطاً عبر الإيميل لتنزيل التطبيق الخاص بالمتابعة وسيقوم د. معاوية بالتواصل معك مباشرة',
    },
    {
      step: '3',
      title: 'ابدأ البرنامج',
  ...
  const differentiators = [
    ...
    'بروتوكول الحد الأدنى الفعال، بدون ما تضيع أي وقت',
    'بناءً على التقييم، يتم تحديد الفحوصات اللازمة لحالتك',
    'خطة تعمل ضمن جدولك الخاص',
    'متابعة مستمرة لمدة 3 أشهر كاملة، مش بس خطة وخلاص',
  ];
          ...
          <div style={{ 
            ...
            <div style={{ 
              ...
              <p className="body-medium" style={{ lineHeight: 1.8, color: 'var(--text-secondary)' }}>
                <strong style={{ color: 'var(--blue-elegant)' }}>ملاحظة مهمة:</strong> بعد إتمام الدفع، ستستلم رابطاً عبر الإيميل لتنزيل التطبيق الخاص بالمتابعة وسيتواصل معك الدكتور مباشرة.
              </p>
            </div>

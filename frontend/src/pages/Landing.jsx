...
const Landing = () => {
  ...
  const targetAudience = [
    ...
    'تريد خطة صحية بسيطة تعمل مع السفر والعشاء والمجالس',
  ];
  ...
  const faqs = [
    {
      ...
      answer: 'جلسة 60 دقيقة عبر Google Meet مع طبيب باطنية مقيم. نناقش أعراضك، نمط حياتك، نتائج التحاليل، ونضع خطة 30 يوم مخصصة تشمل النوم، التغذية، التمارين، والكافيين. تستلم ملف PDF كامل خلال 24 ساعة.',
    },
    {
    ...
    },
    {
      ...
      answer: 'ادفع عبر PayPal مباشرة ($119). بعد إتمام الدفع، ستستلم رابط Calendly عبر البريد الإلكتروني لاختيار موعدك المناسب.',
    },
    {

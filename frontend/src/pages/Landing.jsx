  ...
  const faqs = [
    {
      ...
      answer: 'جلسة 60 دقيقة عبر Google Meet مع طبيب باطنية مقيم. نناقش أعراضك، نمط حياتك، نتائج التحاليل (إذا كانت متوفرة)، ونضع خطة 30 يوم مخصصة تشمل النوم، التغذية، التمارين، والكافيين. تستلم ملف PDF كامل خلال 24 ساعة.',
    },
    {

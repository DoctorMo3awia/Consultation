  ...
  const faqs = [
    {
      ...
      answer: 'جلسة 45 دقيقة عبر Google Meet مع طبيب باطنية مقيم. نناقش أعراضك، نمط حياتك، نتائج التحاليل، ونضع خطة مخصصة تشمل النوم، التغذية، التمارين، والكافيين. تستلم ملف PDF كامل خلال 24 ساعة.',
    },
    {

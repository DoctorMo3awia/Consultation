  ...
  const faqs = [
    {
      ...
      answer: 'برنامج متابعة شخصية 1-on-1 مع طبيب باطنية مقيم لمدة 3 أشهر. نبدأ بتقييم شامل لحالتك ونبني خطة مخصصة لك (نوم، تغذية، مكملات، تمارين)، ثم نتابع تقدمك ونعدّل الخطة حسب استجابة جسمك طوال فترة البرنامج عبر واتساب.',
    },
    {
    ...
    },
    {
      ...
      answer: 'بعد أول جلسة، تستلم ملف PDF كامل يحتوي على خطتك المخصصة. بعدها نتابع تقدمك لمدة 3 أشهر ونعدّل الخطة حسب استجابة جسمك ونتائجك.',
    },
    {
      question: 'ما هو ضمان استرداد الأموال؟',
      answer: 'إذا لم تستفد من الجلسة — نرد لك المبلغ كاملا بلا أسئلة. نحن واثقون من النتائج.',
    },
  ];
      ...
      <section className="hero-section" data-testid="hero-section">
        <div className="hero-content">
          ...
          <p className="body-large" style={{ marginBottom: '2rem', color: 'rgba(255,255,255,0.8)', maxWidth: '600px', marginLeft: 'auto', marginRight: 'auto' }}>
            برنامج متابعة شخصية 1-on-1 لمدة 3 أشهر تحت اشراف طبيب للرجال المشغولين في الإمارات والخليج
          </p>

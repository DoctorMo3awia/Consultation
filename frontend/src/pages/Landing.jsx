...
const Landing = () => {
  ...
  const faqs = [
    {
      question: 'وش الفرق بين البرنامج والاستشارة العادية؟',
      answer: 'الاستشارة العادية = تحصل على خطة وتمشي لحالك. البرنامج = دكتور معاوية يمشي معك الرحلة كاملة 3 أشهر. يبني لك الخطة، يتابع تقدمك، ويعدّل حسب استجابة جسمك. هذا الفرق بين خطة على ورق ونتائج حقيقية.',
    },
    {
      question: 'أنا مشغول جداً، هل البرنامج يناسبني؟',
      answer: 'هذا بالضبط لمين مصمم. الخطة تتناسب مع جدولك الحقيقي — سفر، مطاعم، اجتماعات. ما نطلب منك تغير حياتك، نعدّل الخطة عشان تشتغل مع حياتك.',
    },
    {
      question: 'ليش $680 وأنا أقدر أروح دكتور بـ 200 درهم؟',
      answer: 'لأن الدكتور العادي يعطيك 5 دقائق ووصفة بدون متابعة. هنا تحصل على طبيب متخصص يشتغل معك شخصياً لمدة 3 أشهر — يراقب نتائجك ويعدّل خطتك. الفرق هو النتيجة الحقيقية مو بس زيارة.',
    },
    {
      question: 'كيف تتم المتابعة خلال 3 أشهر؟',
      answer: 'تبدأ بجلسة تقييم شاملة وتستلم خطتك المخصصة. بعدها نتواصل عبر واتساب بشكل مستمر — نتابع تقدمك، نراجع نتائجك، ونعدّل الخطة حسب استجابة جسمك. أنت ما تمشي لحالك أبداً.',
    },
    {
      question: 'هل أحتاج تحاليل مخبرية؟',
      answer: 'بناءً على التقييم الأولي، نحدد التحاليل اللازمة لحالتك. إذا عندك تحاليل حديثة، نبني عليها مباشرة. التحاليل تساعدنا نعطيك خطة دقيقة مبنية على أرقام حقيقية مو تخمين.',
    },
    {
      question: 'وإذا ما حسّيت بفرق؟',
      answer: 'نرجع لك فلوسك كاملة — بدون أسئلة. بس بصراحة، 3 أشهر متابعة شخصية مع طبيب متخصص يعدّل خطتك حسب جسمك؟ النتائج شبه مضمونة.',
    },
  ];
